...
Create a folder called js-functions-lab and create an index.html, style.css, and script.js file inside of it. Set up your HTML with a boiler plate and link all your files together.
