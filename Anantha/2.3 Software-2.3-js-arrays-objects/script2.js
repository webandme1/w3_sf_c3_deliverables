...
// const allFoods = (() => {let result = ""; return foods.reduce((food1, food2) =>  result.concat(food1,"->" ,food2));  })();
const allFoods = foods.toString(foods).replaceAll(",","->")
...
let odds=[]; nums.forEach((num) => (num % 2 == 1) ? odds.push(num) : null);
...
let fizz = []; (() => nums.forEach((num) => (num % 3 == 0) ? fizz.push(num) : null))();
let buzz = []; (() => nums.forEach((num) => (num % 5 == 0) ? buzz.push(num) : null))();
let fizzbuzz = []; (() => nums.forEach((num) => (num % 3 == 0) && (num % 5 == 0) ? fizzbuzz.push(num) : null))();
